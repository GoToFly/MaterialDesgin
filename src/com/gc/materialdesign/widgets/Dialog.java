...
public class Dialog extends android.app.Dialog{
	...
	Boolean isButtonCancel=true;
	
	View.OnClickListener onAcceptButtonClickListener;
	View.OnClickListener onCancelButtonClickListener;
	
	int resId;
	public Dialog(Context context,String title, String message,int resId) {
	...
	public Dialog(Context context,String title, String message,int resId,Boolean showCancelButton) {
		super(context, android.R.style.Theme_Translucent);
		this.message = message;
		this.title = title;
		this.resId=resId;
		this.isButtonCancel=showCancelButton;
	}
